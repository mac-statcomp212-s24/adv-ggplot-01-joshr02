...
ggplot(weather) +
    geom_linerange(aes(ymin=RecordLow,ymax=RecordHigh,x=date), color = "#ECEBE3",linewidth=0.67) +
    geom_linerange(aes(ymin=NormalLow,ymax=NormalHigh,x=date), color = "#C8B8BA",linewidth=0.67) +
    geom_linerange(aes(ymin=Low,ymax=High,x=date), color = "#A90248",linewidth=0.67) +
